...
-- Ajout de password dans la table utilisateur 
ALTER TABLE `utilisateur`
...
COMMIT;
CREATE TABLE amis(
  id_amitie INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
ALTER TABLE `amis`
ADD CONSTRAINT `amis_ibfk_1` FOREIGN KEY (`id_demandeur`) REFERENCES `utilisateur` (`id_user`),
  ADD CONSTRAINT `amis_ibfk_2` FOREIGN KEY (`id_receveur`) REFERENCES `utilisateur` (`id_user`);
...
ADD CONSTRAINT `chat_message_ibfk_1` FOREIGN KEY (`id_conversation`) REFERENCES `conversation` (`id_conversation`),
  ADD CONSTRAINT `chat_message_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `utilisateur` (`id_user`);
...
ADD CONSTRAINT `conversation_message_ibfk_1` FOREIGN KEY (`id_conversation`) REFERENCES `conversation` (`id_conversation`),
  ADD CONSTRAINT `conversation_message_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `utilisateur` (`id_user`);
CREATE TABLE post(
