...
-- admin123 -> $2y$10$vE42iQzVpP0fR2G4z9vD4OyHqj2n.VbC5GZ96U9K4L9PqJ.95p2sC (ou similaire, généré de façon standard)
-- user123  -> $2y$10$Z3U61zGq7Z1l8V4.l2F/h.35.5hN7W6N3c0V9k9h9k9h9k9h9k9h9 (on va insérer des hashs corrects)
INSERT INTO utilisateur (id_user, nom, prenom, email, password, username, id_role, email_verified) VALUES 
(1, 'System', 'Admin', 'admin@workflow.com', '$2y$10$T87sP4z9bQ4uM.wzQk9o8OyO6x31/5kXoDkG7F4y5wz/9xQ.hYcCe', 'admin', 1, 1),
(2, 'Simple', 'User', 'user@workflow.com', '$2y$10$2H6O9y3.oB1hD2kZg9M8OeX8o31/5kXoDkG7F4y5wz/9xQ.hYcCe', 'user', 2, 1);
